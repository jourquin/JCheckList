...
/**
 * Very simple example that creates a list of checkable items. The user can
 * check/uncheck the items he wants. When the window is closed, the state of
 * each item is printed on the standard output.
 * 
...
public class Example {
	...
	public Example() {
		...
		JCheckList<String> jCheckList = new JCheckList<>(myModel);
		...
		frame.getContentPane().add(new JScrollPane(jCheckList));
